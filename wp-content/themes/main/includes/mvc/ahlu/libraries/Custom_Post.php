...
echo '
	<p>Upload Images <a href="#">+Add<a/></p>
	<div class="meta-upload-images"></div>
';                      
                                                ...
                                                echo '<p><label style="width: 20%;display: block;float: left;" for="' . $field_id_name . '">' . ucwords($label) . '</label><input style="width: 50%;" type="text" name="'. $field_id_name . '" id="' . $field_id_name . '" value="' . $meta[$field_id_name][0] . '" /></p>'; 
   ...
   /////////////////////////// Mutil upload    ////////////////////////////
     ...
     * Display the image meta box upload images mutils
