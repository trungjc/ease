				...
				<?php
					...
					if(isset($cart)){
						...
						foreach($cart as $id=> $item){
							...
							$icon  = get_template_directory_uri()."/images/{$cart_fake[$item->product_id]}-enquiry.png";
				...
				<table>
					<tfoot>
						<tr>
							...
							<td colspan="2" class="button"><input type="submit" class="submit" value="Send me my Enquires" /></td>
						</tr>
					</tfoot>
				</table>
			</div>
