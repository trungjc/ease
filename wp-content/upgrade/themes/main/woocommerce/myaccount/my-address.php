	...
	<div class="col-<?php echo ( ( $col = $col * -1 ) < 0 ) ? 1 : 2; ?> address">
		...
		<address style="line-height: 20px;">
			<?php
				...
				$formatted_address = WC()->countries->get_formatted_address( $address )."<br />".get_user_meta( $customer_id, $name . '_email', true );
		...
		<a href="<?php echo wc_get_endpoint_url( 'edit-address', $name ); ?>" class="button  edit" style="font-weight: 600;color: #fff;    padding: 10px 20px!important;
    margin-bottom: 20px;"><?php _e( 'Edit', 'woocommerce' ); ?></a>
	</div>
