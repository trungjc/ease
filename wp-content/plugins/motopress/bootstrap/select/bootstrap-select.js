            ...
            var template =
                "<div class='btn-group bootstrap-select'>" +
                    ...
                    "<div class='dropdown-menu' role='menu'>" +
                        "<ul data-select-id='" + this.$element.prop('id') + "'>" +
                            "__ADD_LI" +
                        "</ul>" +
                    "</div>" +
                "</div>";
            ...
            this.$element.find('option').each(function() {
                ...
                if ($(this).parent().is('optgroup')) {
                    ...
                    for (var i = 0; i < optgroup.length; i++) {
                        ...
                        _liA.push('<a class="opt'+opt_index[i]+'" tabindex="-1" href="#" ' + disabled + '>'+$(this).text()+'</a>');
                    }
                    ...
                    _liA.push('<a tabindex="-1" href="#" ' + disabled + '>'+$(this).text()+'</a>');
                }
            });
...
//                    $select.find('.filter-option').html($this.text());
                    $select.find('.filter-option').html($this.find('a').text());
            ...
            this.$element.on('change', function(e) {
                ...
                $(this).next('.bootstrap-select').find('.motopress-filter-option').html(selected);
            });
        }
