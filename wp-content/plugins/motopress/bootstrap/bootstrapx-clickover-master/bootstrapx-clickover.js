...
!function($) {
  ...
  Clickover.prototype = $.extend({}, $.fn.popover.Constructor.prototype, {
    ...
    , cinit: function( type, element, options ) {
      ...
      this.attr.click_event_ns = "mousedown." + this.attr.me;
      ...
      this.$element.on( 'mousedown', this.options.selector, $.proxy(this.clickery, this) );
    ...
    , clickery: function(e) {
      ...
      if ( this.isShown() ) {
        ...
        this.tip().on('mousedown', '[data-dismiss="clickover"]', $.proxy(this.clickery, this));
